package org.jaguarcode.components;

import mdlaf.utils.MaterialColors;
import org.jaguarcode.main;
        ...
        implements CaretListener, DocumentListener, PropertyChangeListener
{
    ...
    private final static Border OUTER = new MatteBorder(-10, 0, 0, 2, Color.GRAY);
    ...
    public TextLineNumber(JTextComponent component, int minimumDisplayDigits)
    {
        ...
        setFont( main.monoCode.deriveFont(12) );

        setBorderGap( 5 );
        setCurrentLineForeground(MaterialColors.GRAY_50);
